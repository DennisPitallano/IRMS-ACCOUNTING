<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="GarmentManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.GarmentManagementPanel" %>
...
<asp:UpdatePanel ID ="upnlGarments" runat ="server" >
  ...
  <div style ="float:left;">
    ...
    <asp:Button ID="btnNewGarment" runat="server" Text="NEW" CssClass ="btnNew" 
                Font-Names="Verdana" />
        <asp:ModalPopupExtender ID="btnNewGarment_ModalPopupExtender" runat="server" 
            DynamicServicePath="" Enabled="True" PopupControlID="pnlNewSizeModal" 
            PopupDragHandleControlID="pnlNewSizeModalDrag" 
            TargetControlID="btnNewGarment" BackgroundCssClass="bgModal" 
            CancelControlID="imgBtnCloseNewSizeModal">
        </asp:ModalPopupExtender>
    <asp:RoundedCornersExtender ID="btnNewGarment_RoundedCornersExtender" 
                                runat="server" Enabled="True" 
          TargetControlID="btnNewGarment" Radius="3" BorderColor="YellowGreen">
    </asp:RoundedCornersExtender>
    </div>
    <div  style ="float:left; margin-right:5px;">
    <asp:Button ID="btnUpdateGarment" runat="server" Text="UPDATE" CssClass ="btnUpdate" 
                Font-Names="Verdana"  />
        <asp:ModalPopupExtender ID="btnUpdateGarment_ModalPopupExtender" runat="server" 
    ...
    <asp:RoundedCornersExtender ID="btnUpdateGarment_RoundedCornersExtender" 
                                runat="server" Enabled="True" 
          TargetControlID="btnUpdateGarment" Radius="3" BorderColor="YellowGreen">
    </asp:RoundedCornersExtender>
    </div> 
    <div  style ="float:left; margin-right:5px;">
  ...
  <div class ="titleList"> 
      <asp:Image ID="imgList" runat="server" Height="16px" Width ="20px"
          ImageUrl="~/Resources/garments.png" ImageAlign="AbsBottom" /> LIST OF GARMENTS</div>
  <div class ="listContent" >
     <asp:Panel ID ="pnlSizesList" runat ="server" Width ="700px" Height ="370px" ScrollBars ="Auto"  >
          <asp:GridView ID="gvGarmentList" runat="server" CellPadding="4" ForeColor="#333333" 
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image1" runat="server" Height="16px" 
                            ImageUrl="~/Resources/garments.png" />
                    </ItemTemplate>
                </asp:TemplateField>
              ...
              <asp:BoundField DataField="GarmentCode" HeaderText="GARMENT CODE">
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
              </asp:BoundField>
              <asp:BoundField DataField="GarmentDescription" HeaderText="GARMENT DESCRIPTION">
                <HeaderStyle Wrap="False" />
                <ItemStyle Wrap="False" />
              </asp:BoundField>
                <asp:BoundField DataField="TopOrBottom" HeaderText="TOP OR BOTTOM">
                <HeaderStyle Wrap="False" />
      ...
      <table style="width: 100%;">
        <tr>
              <td class ="modalLabel">
                 TOP OR BOTTOM?</td>
              <td>
                  <asp:RadioButtonList ID="rdioTopOrBottom" runat="server" Font-Bold="True" 
                      Font-Names="Verdana" Font-Size="11px" ForeColor="#CCFF99" 
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtGarmentCode" runat="server" Height="22px" Font-Names="Verdana" 
          ...
          <tr>
              ...
              <td>
                  <asp:Button ID="btnSaveGarment" runat="server" Text="SAVE" CssClass ="btnSave" 
                      ToolTip="Save New Fabric" onclick="btnSaveGarment_Click" />
                  <asp:RoundedCornersExtender ID="btnSaveGarment_RoundedCornersExtender" 
                      runat="server" Enabled="True" TargetControlID="btnSaveGarment">
                  </asp:RoundedCornersExtender>
              </td>
              <td>
                  &nbsp;
      ...
      <table style="width: 100%;">
        <tr>
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtGarmentCodeUpdate" runat="server" Height="22px" Font-Names="Verdana" 
                      ForeColor="#333333"></asp:TextBox>
              </td>
              <td>
                  &nbsp;
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtGarmentDescriptionUpdate" runat="server" Height="40px" 
                      TextMode="MultiLine" Font-Names="Verdana" ForeColor="#333333"></asp:TextBox>
              </td>
              <td>
                  &nbsp;
