<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="FabricManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.FabricManagementPanel" %>
...
<asp:UpdatePanel ID ="upnlFabrics" runat ="server" >
  ...
  <div style ="width: 100%; height :30px;">
    ...
    <div style ="float:left;">
      <div  style ="float:left; margin-right:5px;">
        <asp:Button ID="btnNewFabric" runat="server" Text="NEW" CssClass ="btnNew" 
                    Font-Names="Verdana" />
        <asp:ModalPopupExtender ID="btnNewSize_ModalPopupExtender" runat="server" 
                                ...
                                TargetControlID="btnNewFabric" BackgroundCssClass="bgModal" 
                                CancelControlID="imgBtnCloseNewSizeModal">
        </asp:ModalPopupExtender>
        <asp:RoundedCornersExtender ID="btnNewSize_RoundedCornersExtender" 
                                    runat="server" Enabled="True" 
                                    TargetControlID="btnNewFabric" Radius="3" BorderColor="YellowGreen">
      ...
      <div  style ="float:left; margin-right:5px;">
        ...
        <asp:RoundedCornersExtender ID="btnUpdateSize_RoundedCornersExtender" 
                                    runat="server" Enabled="True" 
                                    TargetControlID="btnUpdateFabric" Radius="3" BorderColor="YellowGreen">
        </asp:RoundedCornersExtender>
      </div> 
      <div  style ="float:left; margin-right:5px;">
  ...
  <div class ="titleList"> 
    <asp:Image ID="imgList" runat="server" Height="16px" 
               ImageUrl="~/Resources/knits_.png" ImageAlign="AbsBottom" /> LIST OF FABRICS
  </div>
  <div class ="listContent" >
    <asp:Panel ID ="pnlSizesList" runat ="server" Width ="700px" Height ="370px" ScrollBars ="Auto"  >
      <asp:GridView ID="gvFabricList" runat="server" CellPadding="4" ForeColor="#333333" 
        ...
        <Columns>
          ...
          <asp:BoundField DataField="FabricDescription" HeaderText="FABRIC DESCRIPTION">
            <HeaderStyle Wrap="False" />
            <ItemStyle Wrap="False" />
          </asp:BoundField>
  ...
  <asp:Panel ID ="pnlNewSizeModal" runat ="server" CssClass ="modalFabric" >
    <asp:Panel ID ="pnlNewSizeModalDrag" runat ="server" CssClass="modalFabricDrag" >
      <div class ="close_btn">
    ...
    <table style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFabricCode" runat="server" Font-Names="Verdana" 
                       ForeColor="#333333" Height="22px"></asp:TextBox>
        </td>
        <td>
          &nbsp;
        </td>
      ...
      <tr>
        ...
        <td>
          <asp:Button ID="btnSaveFabric" runat="server" Text="SAVE" CssClass ="btnSave" 
                      ToolTip="Save New Fabric" onclick="btnSaveFabric_Click" />
          <asp:RoundedCornersExtender ID="btnSaveFabric_RoundedCornersExtender" 
                                      runat="server" Enabled="True" TargetControlID="btnSaveFabric">
          </asp:RoundedCornersExtender>
        </td>
        <td>
          &nbsp;
  ...
  <asp:Panel ID ="pnlUpdateSizeModal" runat ="server" CssClass ="modalFabric" >
    <asp:Panel ID ="pnlUpdateSizeModalDrag" runat ="server" CssClass="modalFabricDrag" >
      <div class ="close_btn">
    ...
    <table style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFabricCodeUpdate" runat="server" Height="22px" Font-Names="Verdana" 
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFabricDescriptionUpdate" runat="server" Height="40px" 
                       TextMode="MultiLine" Font-Names="Verdana" ForeColor="#333333"></asp:TextBox>
        </td>
        <td>
          &nbsp;
      ...
      <tr>
        ...
        <td>
          <asp:Button ID="btnSaveUpdate" runat="server" Text="SAVE" CssClass ="btnSave" 
                      ToolTip="Update Fabric" onclick="btnSaveUpdate_Click" />
