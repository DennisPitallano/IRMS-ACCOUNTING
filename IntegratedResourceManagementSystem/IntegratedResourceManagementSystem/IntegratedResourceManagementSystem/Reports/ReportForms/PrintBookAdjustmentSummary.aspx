<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintBookAdjustmentSummary.aspx.cs" Inherits="IntegratedResourceManagementSystem.Reports.ReportForms.PrintBookAdjustmentSummary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Book Adjustment Summary</title>
...
<body>
    ...
    <form id="form1" runat="server">
           ...
           <div style =" margin-bottom: 10px; text-align:left; width: 594px;">
               <asp:Label ID="lblTitle" runat="server" Text="Book Adjustment Summary" Font-Names="Times New Roman" 
