...
<body>
    ...
    <div style="margin: 15px 10px 0px 10px;">
        <div style="text-align: right; font-size: 10px; font-family: Verdana;">
            <asp:Label ID="lblDateNow" runat="server" Text="Label" Font-Names="Verdana" Font-Size="10px"></asp:Label>
        </div>
        <div>
            <asp:Label ID="Label1" runat="server" Text="STORE OUTSTANDING INVENTORY" Font-Bold="true"
        ...
        <div>
            ...
            <br />
            <br />
            <asp:Label ID="lblDatePeriodFrom" runat="server" Text="PERIOD FROM" Font-Names="Verdana"
                Font-Size="12px" Font-Bold="true"></asp:Label>
            <div style="margin-left: 70px;">
                <asp:Label ID="lblDatePerioTo" runat="server" Text="PERIOD To" Font-Names="Verdana"
                    Font-Size="12px" Font-Bold="true"></asp:Label>
            </div>
            <br />
        </div>
        <table style="width: 100%;" cellspacing="0">
            ...
            <tr>
                ...
                <td class="lblData">
                    <asp:Label ID="lblGrossSalesAvgCost" runat="server" Text="GrossSalesAvgCost"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="titleLabel">
            ...
            <tr>
                ...
                <td class="lblResultData2">
                    <asp:Label ID="lblDiscrepancyVolume" runat="server" Text="DiscrepancyVolume"></asp:Label>
                </td>
                <td class="lblResultData2">
                    <asp:Label ID="lblDiscrepancyValue" runat="server" Text="DiscrepancyValue"></asp:Label>
                </td>
                <td class="lblResultData2">
                    <asp:Label ID="lblDiscrepancyTotalCost" runat="server" Text="DiscrepancyTotalCost"></asp:Label>
                </td>
                <td class="lblResultData2">
                    &nbsp;
                </td>
