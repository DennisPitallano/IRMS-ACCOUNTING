        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="ENDING INVTY">
                    <ItemTemplate>
                        <asp:Label ID="lblEndingCost" runat="server" Text='<%#  Eval("EndingInventory") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
    ...
    <div>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table"
            ...
            <Columns>
                <asp:TemplateField HeaderText="BRAND NAME">
                    <ItemTemplate>
                        <asp:Label ID="Label23" runat="server" Text='<%# Bind("Brand") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        TOTAL
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF BOOK QTY (LKG / OVER)">
                    <ItemTemplate>
                        <asp:Label ID="lblPercentageQty0" runat="server" Text='<%# Eval("PercentOfBookOverQty") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPrecentBookQtyFormatted().ToString()%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ENDING INVTY">
                    <ItemTemplate>
                        <asp:Label ID="lblEndingCost0" runat="server" Text='<%#  Eval("EndingInventory") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalEndingInvtCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ACTUAL P.COUNT COST">
                    <ItemTemplate>
                        <asp:Label ID="Label24" runat="server" Text='<%# GetActualPcountCost(double.Parse(Eval("ActualPCountCost").ToString())).ToString("0,000.00") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalActualPcountCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="VARIANCE COST">
                    <ItemTemplate>
                        <asp:Label ID="lblVarianceCost0" runat="server" Text='<%# Eval("VarianceCost","{0:0,000}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalVarianceCostFormatted().ToString()%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="AVE.PER COST">
                    <ItemTemplate>
                        <asp:Label ID="Label25" runat="server" Text='<%# Bind("AvePerCost","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalAveragePerPcount().ToString("#,###.##")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF COST LKG. (LKG / BOOK)">
                    <ItemTemplate>
                        <asp:Label ID="lblCostLkgBook0" runat="server" Text='<%# Eval("PercentOfCostLacking","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPercentCostLkgFormatted().ToString()%>
                    </FooterTemplate>
    ...
    <div>
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CssClass="table"
            ...
            <Columns>
                <asp:TemplateField HeaderText="BRAND NAME">
                    <ItemTemplate>
                        <asp:Label ID="Label26" runat="server" Text='<%# Bind("Brand") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        TOTAL
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF BOOK QTY (LKG / OVER)">
                    <ItemTemplate>
                        <asp:Label ID="lblPercentageQty1" runat="server" Text='<%# Eval("PercentOfBookOverQty") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPrecentBookQtyFormatted().ToString()%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ENDING INVTY">
                    <ItemTemplate>
                        <asp:Label ID="lblEndingCost1" runat="server" Text='<%#  Eval("EndingInventory") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalEndingInvtCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ACTUAL P.COUNT COST">
                    <ItemTemplate>
                        <asp:Label ID="Label27" runat="server" Text='<%# GetActualPcountCost(double.Parse(Eval("ActualPCountCost").ToString())).ToString("0,000.00") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalActualPcountCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="VARIANCE COST">
                    <ItemTemplate>
                        <asp:Label ID="lblVarianceCost1" runat="server" Text='<%# Eval("VarianceCost","{0:0,000}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalVarianceCostFormatted().ToString()%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="AVE.PER COST">
                    <ItemTemplate>
                        <asp:Label ID="Label28" runat="server" Text='<%# Bind("AvePerCost","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalAveragePerPcount().ToString("#,###.##")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF COST LKG. (LKG / BOOK)">
                    <ItemTemplate>
                        <asp:Label ID="lblCostLkgBook1" runat="server" Text='<%# Eval("PercentOfCostLacking","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPercentCostLkgFormatted().ToString()%>
                    </FooterTemplate>
    ...
    <div>
        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CssClass="table"
            ...
            <Columns>
                <asp:TemplateField HeaderText="BRAND NAME">
                    <ItemTemplate>
                        <asp:Label ID="Label29" runat="server" Text='<%# Bind("Brand") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        TOTAL
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF BOOK QTY (LKG / OVER)">
                    <ItemTemplate>
                        <asp:Label ID="lblPercentageQty2" runat="server" Text='<%# Eval("PercentOfBookOverQty") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPrecentBookQtyFormatted().ToString()%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ENDING INVTY">
                    <ItemTemplate>
                        <asp:Label ID="lblEndingCost2" runat="server" Text='<%#  Eval("EndingInventory") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalEndingInvtCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="ACTUAL P.COUNT COST">
                    <ItemTemplate>
                        <asp:Label ID="Label30" runat="server" Text='<%# GetActualPcountCost(double.Parse(Eval("ActualPCountCost").ToString())).ToString("0,000.00") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalActualPcountCost().ToString("0,000.00")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="AVE.PER COST">
                    <ItemTemplate>
                        <asp:Label ID="Label31" runat="server" Text='<%# Bind("AvePerCost","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalAveragePerPcount().ToString("#,###.##")%>
                    </FooterTemplate>
                ...
                <asp:TemplateField HeaderText="% OF COST LKG. (LKG / BOOK)">
                    <ItemTemplate>
                        <asp:Label ID="lblCostLkgBook2" runat="server" Text='<%# Eval("PercentOfCostLacking","{0:0,000.00}") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <%# GetTotalPercentCostLkgFormatted().ToString()%>
                    </FooterTemplate>
