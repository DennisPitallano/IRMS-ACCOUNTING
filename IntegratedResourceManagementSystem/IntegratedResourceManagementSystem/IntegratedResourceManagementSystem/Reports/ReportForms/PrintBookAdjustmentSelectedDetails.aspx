<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintBookAdjustmentSelectedDetails.aspx.cs"
    Inherits="IntegratedResourceManagementSystem.Reports.ReportForms.PrintBookAdjustmentSelectedDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Book Adjustment Details</title>
...
<body>
    ...
    <div align="center">
        <div style="text-align: center; margin-top: 5px; font-size: 11px; width: 550px; margin-top: 50px;
            padding: 30px 0px 30px 0px; border: 1px Solid Black;">
            <table cellspacing="0" style="width: 100%; font-family: Times New Roman;">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <asp:Label ID="lblDate" runat="server" Text="Label" Font-Bold="True" Font-Italic="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="lblPreview">
                    ...
                    <td colspan="3" style="text-align: left;">
                        ...
                        &nbsp;TO &nbsp;<asp:Label ID="lblPeriodTo" runat="server" Text="Label" Font-Bold="True"
                            Font-Size="11px"></asp:Label>
                    </td>
                </tr>
                <tr>
