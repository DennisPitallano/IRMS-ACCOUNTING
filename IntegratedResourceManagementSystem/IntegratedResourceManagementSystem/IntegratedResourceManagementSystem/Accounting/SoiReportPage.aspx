        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:RadioButtonList ID="rblist1" runat="server" RepeatColumns="1" RepeatDirection="Horizontal"
                    ...
                    <asp:ListItem Value="rptBrandInvSumm">SUMMARY OF BRAND INVENTORY  
                    </asp:ListItem>
                    <asp:ListItem Value="rptStoreInvSumm">SUMMARY OF STORE INVENTORY 
                    </asp:ListItem>
                    <asp:ListItem Value="rptSummMonthlyInvPerBrand">SUMMARY OF MONTHLY INVENTORY PER BRAND 
                    </asp:ListItem>
                    <asp:ListItem Value="rptConsoSummMonthlyInvPerBrand">CONSOLIDATED SUMMARY OF MONTHLY INVENTORY PER BRAND 
                    </asp:ListItem>
                </asp:RadioButtonList>
            </ContentTemplate>
        </asp:UpdatePanel>
