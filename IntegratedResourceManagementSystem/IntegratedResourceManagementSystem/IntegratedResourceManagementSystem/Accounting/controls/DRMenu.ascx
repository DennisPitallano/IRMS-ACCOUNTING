<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DRMenu.ascx.cs" Inherits="IntegratedResourceManagementSystem.Accounting.controls.DRMenu" %>
<style type ="text/css" >
   .mnuIcon
    {
        width:115px;
...
<div style ="float:left; width: 150px; margin-right:5px;">
  <div class ="mnuIcon">
    <asp:ImageButton ID="imgBtnDeliveryReceiptConfirmation" runat="server" 
                     ImageUrl="~/Resources/invoice.png" Height="36px" 
                     ToolTip="Delivery Receipt Confirmation" 
                     
          PostBackUrl="~/Accounting/DeliveryReceiptConfirmationPanel.aspx" />
    <br />
