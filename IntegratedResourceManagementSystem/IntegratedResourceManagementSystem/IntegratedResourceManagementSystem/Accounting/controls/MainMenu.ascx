...
<asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" EnableViewState="false"
    ...
    <Items>
        ...
        <asp:MenuItem NavigateUrl="~/Accounting/SalesInvoice.aspx" Text="SALES INVOICE" Value="SALES INVOICE">
        </asp:MenuItem>
        <asp:MenuItem NavigateUrl="~/Accounting/ReportPanel.aspx" Text="REPORTS" ToolTip="Reports"
