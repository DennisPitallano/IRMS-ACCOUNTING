<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Accounting.Master" AutoEventWireup="true" CodeBehind="MemoForm.aspx.cs" Inherits="IntegratedResourceManagementSystem.Accounting.DebitMemoForm" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <div class="modalText" style ="text-align:center; margin-bottom:15px;">
        ...
        <div >
            ...
            <asp:RadioButtonList ID="rdioMemoType" CssClass="optionMemoType" runat="server" AutoPostBack="True" 
                onselectedindexchanged="rdioMemoType_SelectedIndexChanged" 
          ...
          <asp:MultiView ID="mvMemoForms" runat="server" ActiveViewIndex="0">
              ...
              <div class="modalDrag"> 
                ...
                <table style="width: 100%;">
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtReferenceNumber" runat="server" Font-Size="10px" CssClass="modalText" Width ="120px" Height="19px" AutoPostBack="True" 
                            ontextchanged="txtReferenceNumber_TextChanged"></asp:TextBox>
                    </td>
                    <td  class="input-form-label">
                      DATE:
                    </td>
                    <td colspan="2">
                      <asp:TextBox ID="txtDate" runat="server" Font-Size="10px" CssClass="modalText" Height ="20px" AutoPostBack="True" 
                            ontextchanged="txtDate_TextChanged" Width ="120px"></asp:TextBox>
                  ...
                  <tr>
                    ...
                    <td colspan="4">
                      <asp:TextBox ID="txtDatePeriodFrom" runat="server" Font-Size="10px" CssClass="modalText" Height ="20px" Width="120px" 
                            AutoPostBack="True" ontextchanged="txtDatePeriodFrom_TextChanged" ></asp:TextBox>
                      ...
                      <asp:TextBox ID="txtDatePeriodTo" runat="server" Font-Size="10px" CssClass="modalText" Height="20px" 
                            AutoPostBack="True" ontextchanged="txtDatePeriodTo_TextChanged" Width ="120px" ></asp:TextBox>
                  ...
                  <tr>
                    <td class ="input-form-label">
                      OUTLET:</td>
                    <td colspan="4">
                        <asp:TextBox ID="txtDebitMemoOutlet" runat="server" Font-Size="10px" CssClass="modalText" Height="20px" Width="250px"></asp:TextBox>
                    </td>
                  </tr>
                  <tr>
                    <td class ="input-form-label">
                ...
                <div>
                  ...
                  <label class ="input-form-label">  PARTICULARS
                    </label>
                    ...
                    <asp:ImageButton ID="ibtnDeleteParticular" runat="server" Height="16px" 
                                     ImageAlign="AbsBottom" ImageUrl="~/Resources/reload.png" 
                          onclick="ibtnDeleteParticular_Click" ToolTip="RESET"/>
                      ...
                      <div>
                          <table style="width: 100%;" Cellpadding="0" Cellspacing="0">
                              <tr>
                                  ...
                                  <td>
                                      <asp:TextBox ID="txtDebitTotalQuantity" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">0</asp:TextBox>
                                  </td>
                                  <td>
                                      <asp:TextBox ID="txtDebitTotalCurrentPrice" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">Php0.00</asp:TextBox>
                                  </td>
                                  <td>
                                     <asp:TextBox ID="txtDebitTotalCostPrice" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">Php0.00</asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td>
              ...
              <asp:Panel ID ="pnlNewParticularModal" runat ="server" CssClass ="modal" >
                ...
                <table style="width: 100%;">
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="dlItems" runat="server" CssClass="modalText"
                            ForeColor="#CC6600" AutoPostBack="True" 
                            onselectedindexchanged="dlItems_SelectedIndexChanged">
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtParticularQuantity" runat="server" Height="22px" 
                                   CssClass="modalText" Font-Size="12px" ForeColor="#CC3300"></asp:TextBox>
                    </td>
                    <td>
                      &nbsp;
                    </td>
                  ...
                  <tr>
                    ...
                    <div style="height:26px;">
                      <asp:Button ID="btnAddParticular" runat="server" Text="ADD" CssClass ="btnNew" 
                                  onclick="btnAddParticular_Click" Enabled="False" />
                      </div>
                    </td>
                    <td>
                      &nbsp;
            ...
            <asp:View ID ="vCreditMemoForm" runat ="server" >
              ...
              <div class="modalDrag">
                ...
                <table style="width: 100%;">
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtCreditReferenceNumber" runat="server" Width ="120px" CssClass="modalText" Font-Size="10px" 
                            Height="19px" AutoPostBack="True" ontextchanged="txtCreditReferenceNumber_TextChanged"></asp:TextBox>
                    </td>
                    <td class ="input-form-label">
                      DATE:
                    </td>
                    <td colspan="2">
                      <asp:TextBox ID="txtDateCredit" runat="server" CssClass="modalText" Font-Size="10px" Height="20px" AutoPostBack="True" 
                            ontextchanged="txtDateCredit_TextChanged" Width="120px"></asp:TextBox>
                      <asp:CalendarExtender ID="CalendarExtender1" runat="server" 
                                            Enabled="True" TargetControlID="txtDateCredit" Format="MMMM d, yyyy">
                      </asp:CalendarExtender>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="4">
                      <asp:TextBox ID="txtDateCreditfrom" runat="server" CssClass="modalText" Font-Size="10px" Height="20px" Width="120px" AutoPostBack="True" 
                            ontextchanged="txtDateCreditfrom_TextChanged"></asp:TextBox>
                      <asp:CalendarExtender ID="CalendarExtender2" runat="server" 
                                            Enabled="True" Format="MMMM d, yyyy" TargetControlID="txtDateCreditfrom">
                      </asp:CalendarExtender>
                       &nbsp; <asp:Label ID="Label1" runat="server" Text="TO" class="input-form-label"></asp:Label>&nbsp;&nbsp;&nbsp;
                      <asp:TextBox ID="txtDateCreditTo" runat="server" CssClass="modalText" Font-Size="10px" Height="20px" 
                            AutoPostBack="True" ontextchanged="txtDateCreditTo_TextChanged" Width ="120px"></asp:TextBox>
                      <asp:CalendarExtender ID="CalendarExtender3" runat="server" Enabled="True" 
                                            Format="MMMM d, yyyy" TargetControlID="txtDateCreditTo">
                      </asp:CalendarExtender>
                    </td>
                  </tr>
                  <tr>
                    <td class="input-form-label">
                      OUTLET:</td>
                    <td colspan="4">
                        <asp:TextBox ID="txtCreditMemoOutlet" runat="server" CssClass="modalText" Font-Size="10px" Height="20px" Width="250px"></asp:TextBox>
                    </td>
                  </tr>
                  <tr>
                    <td class="input-form-label">
                ...
                <div>
                  <div  style ="font-family :Verdana; color:White; margin-left: 10px;">
                   <label class="input-form-label">PARTICULARS</label>
                    <asp:ImageButton ID="ibtnNewCreditMemo" runat="server" 
                                     ImageUrl="~/Resources/new.png" 
                                     onclick="ibtnAddParticular_Click" Height="16px" ImageAlign="AbsBottom" />
      
                    <asp:ModalPopupExtender ID="ModalPopupExtender1" 
                                            runat="server" DynamicServicePath="" Enabled="True" 
                                            TargetControlID="ibtnNewCreditMemo" 
                                            CancelControlID="imgBtnCloseNewCreditMemo" 
                                            PopupControlID="pnlNewCreditParticularModal" 
                                            PopupDragHandleControlID="pnlNewCreditParticularModalDrag" 
                                            BackgroundCssClass="bgModal">
                    </asp:ModalPopupExtender>
      
                    <asp:ImageButton ID="ibtnResetCredit" runat="server" Height="16px" 
                                     ImageAlign="AbsBottom" ImageUrl="~/Resources/reload.png" 
                                     ToolTip ="RESET" onclick="ibtnResetCredit_Click" />
                       ...
                       <div>
                          <table style="width: 100%;" Cellpadding="0" Cellspacing="0">
                              <tr>
                                  ...
                                  <td>
                                      <asp:TextBox ID="txtCreditTotalQuantity" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">0</asp:TextBox>
                                  </td>
                                  <td>
                                      <asp:TextBox ID="txtCreditTotalCurrentPrice" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">Php0.00</asp:TextBox>
                                  </td>
                                  <td>
                                     <asp:TextBox ID="txtCreditTotalCostPrice" runat="server" Font-Size="11px" 
                                          Font-Names="Verdana" ForeColor="#CC3300" Width="112px" ReadOnly="True">Php0.00</asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td>
              ...
              <asp:RoundedCornersExtender ID="RoundedCornersExtender4" 
                                          runat="server" Enabled="True" TargetControlID="pnlNewCreditMemo">
              ...
              <asp:Panel ID ="pnlNewCreditParticularModal" runat ="server" CssClass ="modal" >
                <asp:Panel ID ="pnlNewCreditParticularModalDrag" runat ="server" CssClass="modalDrag" >
                  <div class ="close_btn">
                    <asp:ImageButton ID="imgBtnCloseNewCreditMemo" runat="server" 
                                     CssClass ="btnClose" ImageUrl="~/Resources/cancel_gray.png" ToolTip="CLOSE"/>
                  </div> 
                  <div class ="sizeLogo">
                ...
                <table style="width: 100%;">
                  <tr>
                    ...
                    <td>
                      <asp:DropDownList ID="dlParticulars" runat="server" CssClass="modalText"
                            ForeColor="#CC6600" Height="22px" AutoPostBack="True" 
                            onselectedindexchanged="dlParticulars_SelectedIndexChanged">
                          <asp:ListItem>--SELECT--</asp:ListItem>
                  ...
                  <tr>
                    <td class="input-form-label">
                      QUANTITY:</td>
                    <td>
                      <asp:TextBox ID="txtCreditQuantity" runat="server" Height="22px" 
                                 CssClass="modalText" Font-Size="12px" ForeColor="#CC3300"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtCreditCurrentPrice" runat="server" Height="22px" 
                               CssClass="modalText" Font-Size="12px" ForeColor="#CC3300"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <asp:TextBox ID="txtCreditCostPrice" runat="server" Height="22px" 
                                   CssClass="modalText" Font-Size="12px" ForeColor="#CC3300"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                    <div style="height:26px;">
                      <asp:Button ID="btnAddCreditMemo" runat="server" Text="ADD" CssClass ="btnNew" 
                            onclick="btnAddCreditMemo_Click" Enabled="False" />
                      </div>
                    </td>
                    <td>
                    </td>
                        ...
                        <table style="width: 100%;" Cellpadding="0" Cellspacing="0">
                            <tr>
                                <td class ="preview_lbl_t">
                                   Inventory Date:</td>
                                <td>
                                    <asp:TextBox ID="txtInventoryDate" runat="server" Font-Bold="True"
                                         CssClass="modalText" Font-Size="10px" ForeColor="#003366" Height="20px"></asp:TextBox>
                                </td>
                                <td class ="preview_lbl_t">
                                 Cut-Off:</td>
                                <td>
                                    <asp:TextBox ID="txtCutOffDate" runat="server" Font-Bold="True" CssClass="modalText" Font-Size="10px"
                                     ForeColor="#003366" Height="20px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtActualPhysicalCountQuantity" runat="server" 
                                        Font-Bold="True" CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        AutoPostBack="True" 
                                        ontextchanged="txtActualPhysicalCountQuantity_TextChanged">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtActualPhysicalCountCurrentPrice" runat="server" 
                                        Font-Bold="True"  CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        AutoPostBack="True" 
                                        ontextchanged="txtActualPhysicalCountCurrentPrice_TextChanged">0.00</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtActualPhysicalPriceCostPrice" runat="server" 
                                        Font-Bold="True"  CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        AutoPostBack="True" 
                            ...
                            <tr>
                                <td class ="output-label">
                                    Sales</td>
                                <td>
                                    <asp:TextBox ID="txtTotalSalesQuantity" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalSalesCurrentPrice" runat="server" Font-Bold="True" 
                                         CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalSalesCostPrice" runat="server" Font-Bold="True" 
                                       CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class ="output-label">
                                    Returns</td>
                                <td>
                                    <asp:TextBox ID="txtTotalReturnsQuantity" runat="server" Font-Bold="True" 
                                         CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalReturnsCurrentPrice" runat="server" Font-Bold="True" 
                                       CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalReturnsCostPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class ="output-label">
                                    Others</td>
                                <td>
                                    <asp:TextBox ID="txtTotalOthersQuantity" runat="server" Font-Bold="True" 
                                         CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalOthersCurrentPrice" runat="server" Font-Bold="True" 
                                       CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalOthersCostPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                               ...
                               <hr />
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalDebitQuantity" runat="server" Font-Bold="True" 
                                       CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        ReadOnly="True">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalDebitCurrentPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalDebitCostPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" 
                                    ForeColor="#CC3300" Height="20px">0</asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalDeliveriesCostPriceSummary" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="22px" 
                                        ReadOnly="True">Php0.00</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class ="output-label">
                                   Others</td>
                                <td>
                                    <asp:TextBox ID="txtTotalOthersCreditSummary" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px" 
                                        >0</asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalCreditQuantity" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalCreditCurrentPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="20px">0</asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotalCreditCostPrice" runat="server" Font-Bold="True" 
                                        CssClass="modalText" Font-Size="10px" ForeColor="#CC3300" Height="22px">0</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
    ...
    <div  class="form-output" style ="text-align :center; padding-bottom:5px; padding-top:5px; margin-top:10px;">
                    <asp:Button ID="btnSaveMemo" runat="server" Text="SAVE" CssClass ="btnSave" 
                        onclick="btnSaveMemo_Click" />
                    <asp:ModalPopupExtender ID="btnSaveMemo_ModalPopupExtender" runat="server" 
                        DynamicServicePath="" Enabled="True" PopupControlID="pnlConfirmSaving" 
                        PopupDragHandleControlID="pnlConfirmSavingDrag" 
                        TargetControlID="btnSaveMemo" CancelControlID="btnNo" 
                        BackgroundCssClass="bgModal">
                    </asp:ModalPopupExtender>
 ...
 <asp:Panel ID ="pnlConfirmSaving" runat ="server" CssClass ="modal" >
    ...
    <div class="input-form-label" style ="font-family :Verdana;text-align :center; font-size: 12px; margin:5px 5px;"">
       <img src="../Resources/warning.png" align="top" alt="" />
        Are you sure you want to save this data?
    </div>
    <div style =" margin:10px 0px 5px 0px; text-align :center; ">
        
        <asp:Button ID="btnOKSaveMEMO" runat="server" Text="YES" 
            CssClass ="modalWarningButtonYes" onclick="btnOKSaveMEMO_Click" />
         <asp:Button ID="btnNo" runat="server" Text="NO" CssClass ="modalWarningButtonNo" />
    </div>
 </asp:Panel>
       <asp:Label ID="lblSaved" runat="server" Text=""></asp:Label>
        <asp:ModalPopupExtender ID="lblSaved_ModalPopupExtender" runat="server" 
            DynamicServicePath="" Enabled="True" PopupControlID="pnlSaved" 
            PopupDragHandleControlID="pnlSavedDrag" TargetControlID="lblSaved" 
            BackgroundCssClass="bgModal">
        </asp:ModalPopupExtender>
         ...
         <asp:Panel ID= "pnlSavedDrag" runat ="server" CssClass ="modalDrag">
          ...
          <img src="../Resources/product.png" alt="FORM" height="16px" align="top" />
            ...
            <div style ="text-align:center; padding:5px 30px;">
                <asp:Label ID="Label3" runat="server" Text="Item Successfully Saved!" 
