<%@ Page Title="" Language="C#" MasterPageFile="~/Accounting/Accounting.Master" AutoEventWireup="true"
    CodeBehind="NewBookAdjustment.aspx.cs" Inherits="IntegratedResourceManagementSystem.Accounting.NewBookAdjustment" %>
<%@ Register Src="~/Accounting/controls/MainMenu.ascx" TagName="MAIN_MENU" TagPrefix="irms" %>
<%@ PreviousPageType VirtualPath="~/Accounting/BookAdjustmentPanel.aspx" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="../Styles/book-adjustment-form.css" rel="stylesheet" type="text/css" />
</asp:Content>
        ...
        <ContentTemplate>
            <div style="width: 100%;min-height:390px;">
                <div class="modalText" style="text-align: center; margin-bottom: 15px;">
                    <asp:Label ID="lblNewBookAdjustment" runat="server" Text="BOOK ADJUSTMENT" Font-Bold="True"
                ...
                <div style="float: left; margin: 5px 10px 5px 5px;">
                    <div>
                        <asp:Label ID="lblSelectMemo" runat="server" CssClass="input-form-label" Text="SELECT MEMO TYPE"></asp:Label>
                        <asp:RadioButtonList ID="rdioMemoType" CssClass="optionMemoType" runat="server" AutoPostBack="True" RepeatDirection="Horizontal"
                    ...
                    <asp:MultiView ID="mvMemoForms" runat="server" ActiveViewIndex="0">
                        <asp:View ID="vDebitMemoForm" runat="server">
                            <asp:Panel ID="pnlDebitMemo" runat="server" CssClass ="input-form modal">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtReferenceNumber" runat="server" CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Width="120px" Height="19px" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                        <td class ="input-form-label">
                                            DATE:
                                        </td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="modalText" Font-Size="11px" ForeColor="#003366"
                                                Height="20px" AutoPostBack="True" Width="120px"></asp:TextBox>
                                            <asp:CalendarExtender ID="txtDate_CalendarExtender" runat="server" Enabled="True"
                                                TargetControlID="txtDate" Format="MMMM d, yyyy"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class ="input-form-label">
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtDatePeriodFrom" runat="server" CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Height="20px" Width="120px" AutoPostBack="True"></asp:TextBox>
                                            <asp:CalendarExtender ID="txtDate0_CalendarExtender" runat="server" Enabled="True"
                                                Format="MMMM d, yyyy" TargetControlID="txtDatePeriodFrom"></asp:CalendarExtender>
                                            &nbsp;
                                            <asp:Label ID="Label2" runat="server" CssClass="input-form-label" Text="TO" ></asp:Label>&nbsp;&nbsp;&nbsp;
                                            <asp:TextBox ID="txtDatePeriodTo" runat="server" CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Height="20px" AutoPostBack="True" Width="120px"></asp:TextBox>
                                            <asp:CalendarExtender ID="txtDate1_CalendarExtender" runat="server" Enabled="True"
                                                Format="MMMM d, yyyy" TargetControlID="txtDatePeriodTo"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class ="input-form-label">
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtDebitMemoOutlet" runat="server" CssClass="modalText" Font-Size="11px"
                                                Height="22px" Width="250px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class ="input-form-label">
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtDebitBrand" runat="server" CssClass="modalText" Font-Size="11px"
                                                Height="22px">CRISSA</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="modalLabel">
                                    ...
                                    <div style="font-family: Verdana; color: White; margin-left: 10px;">
                                       <label class="input-form-label" >PARTICULARS</label>
                                        <asp:ImageButton ID="ibtnAddParticular0" runat="server" ImageUrl="~/Resources/new.png"
                                            Height="16px" ImageAlign="AbsBottom" />
                                        <asp:ModalPopupExtender ID="ibtnAddParticular0_ModalPopupExtender" runat="server"
                                            ...
                                            BackgroundCssClass="bgModal"></asp:ModalPopupExtender>
                                        <asp:ImageButton ID="ibtnDeleteParticular" runat="server" Height="16px" ImageAlign="AbsBottom"
                                            ImageUrl="~/Resources/reload.png" ToolTip="RESET" />
                                    </div>
                                    <hr />
                                        ...
                                        <asp:Panel ID="pnlParticulars" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="gvParticulars" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CurrentPrice" HeaderText="CURRENT PRICE" DataFormatString="Php{0:###,###.00}"><ItemStyle ForeColor="Red" /></asp:BoundField>
                                                    <asp:BoundField DataField="CostPrice" HeaderText="COST PRICE" DataFormatString="Php{0:###,###.00}"><ItemStyle ForeColor="Red" /></asp:BoundField>
                                                </Columns>
                          ...
                          <asp:Panel ID="pnlNewParticularModal" runat="server" CssClass="modal">
                                <asp:Panel ID="pnlNewParticularModalDrag" runat="server" CssClass="modalDrag">
                                    ...
                                    <div class="sizeLogo">
                                        <asp:Image ID="Image1" runat="server" Height="16px" ImageUrl="~/Resources/usermode.png" />
                                        NEW PARTICULAR
                                    </div>
                                </asp:Panel>
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <div style="height:26px;">
                                            <asp:Button ID="btnAddParticular" runat="server" Text="ADD" CssClass="btnNew" Enabled="False"
                        ...
                        <asp:View ID="vCreditMemoForm" runat="server">
                            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal input-form">
                               <div class="modalDrag">
                                    <div class="sizeLogo">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCreditReferenceNumber" runat="server" Width="120px" CssClass="modalText"
                                                Font-Size="11px" ForeColor="#003366" Height="19px" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                        <td class="input-form-label">
                                            DATE:
                                        </td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtDateCredit" runat="server" CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Height="20px" AutoPostBack="True" Width="120px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtDateCreditfrom" runat="server"  CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Height="20px" Width="120px" AutoPostBack="True"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" Format="MMMM d, yyyy"
                                                TargetControlID="txtDateCreditfrom"></asp:CalendarExtender>
                                            &nbsp;
                                            <asp:Label ID="Label1" runat="server" Text="TO" CssClass="input-form-label"></asp:Label>&nbsp;&nbsp;&nbsp;
                                            <asp:TextBox ID="txtDateCreditTo" runat="server" CssClass="modalText" Font-Size="11px"
                                                ForeColor="#003366" Height="20px" AutoPostBack="True" Width="120px"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender3" runat="server" Enabled="True" Format="MMMM d, yyyy"
                                                TargetControlID="txtDateCreditTo"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="input-form-label">
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtCreditMemoOutlet" runat="server" CssClass="modalText" Font-Size="11px"
                                                Height="22px" Width="250px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtCreditBrand" runat="server" CssClass="modalText" Font-Size="11px"
                                                Height="22px">CRISSA</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <asp:RoundedCornersExtender ID="RoundedCornersExtender4" runat="server" Enabled="True"
                                TargetControlID="pnlNewCreditMemo"></asp:RoundedCornersExtender>
                            ...
                            <asp:Panel ID="pnlNewCreditParticularModal" runat="server" CssClass="modal">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <div style="height:26px;">                                        
                                            <asp:Button ID="btnAddCreditMemo" runat="server" Text="ADD" CssClass="btnNew" Enabled="False"
                                                OnClick="btnAddCreditMemo_Click" />
                                        </div>
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: center">
                                            <asp:Label ID="lblErrorCredit" runat="server" Font-Bold="True" Font-Names="Verdana"
                                                Font-Size="12px" ForeColor="#D25D00"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                                ...
                                <div class="form-output">
                                    <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtInventoryDate" runat="server" Font-Bold="True" CssClass="modalText"
                                                 Font-Size="11px" ForeColor="#003366" Height="20px"></asp:TextBox>
                                                <asp:CalendarExtender ID="txtInventoryDate_CalendarExtender" runat="server" Enabled="True"
                                                    Format="MMMM dd, yyyy" TargetControlID="txtInventoryDate">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCutOffDate" runat="server" Font-Bold="True" CssClass="modalText"
                                                 Font-Size="11px" ForeColor="#003366" Height="20px"></asp:TextBox>
                                                <asp:CalendarExtender ID="txtCutOffDate_CalendarExtender" runat="server" Enabled="True"
                                                    Format="MMMM dd, yyyy" TargetControlID="txtCutOffDate">
                                                </asp:CalendarExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTotalOthersQuantity" runat="server" Font-Bold="True"  Font-Size="10px"
                                                    CssClass="modalText" ForeColor="#CC3300" Height="20px" ReadOnly="True">0</asp:TextBox>
                                            </td>
                                            <td>
            ...
            <div class="form-output" style="text-align: center; padding-bottom:5px; padding-top:5px;">
                ...
                <asp:ModalPopupExtender ID="btnSaveMemo_ModalPopupExtender" runat="server" 
                    ...
                    Enabled="True" PopupControlID="pnlConfirmSaving" 
                    PopupDragHandleControlID="pnlConfirmSavingDrag" TargetControlID="btnSaveMemo">
                </asp:ModalPopupExtender>
                <asp:Button ID="btnCancel" runat="server" CssClass="btnCancel" Text="CANCEL" PostBackUrl="~/Accounting/BookAdjustmentPanel.aspx" />
            </div>
            <asp:Panel ID="pnlConfirmSaving" runat="server" CssClass="modal">
                ...
                <div  class="input-form-label" style="text-align: center; font-size:10px;
                    margin: 5px;">
         ...
         <asp:Panel ID= "pnlSavedDrag" runat ="server" CssClass ="modalDrag">
          ...
          <img src="../Resources/product.png" height="16px" align="top" />
            ...
            <asp:Button ID="btnOk" runat="server" Text="OK" CssClass="modalWarningButtonYes" 
                    onclick="btnOk_Click" />
            <asp:RoundedCornersExtender ID="btnOk_RoundedCornersExtender" runat="server" 
                Enabled="True" TargetControlID="btnOk" BorderColor="LightGray">
