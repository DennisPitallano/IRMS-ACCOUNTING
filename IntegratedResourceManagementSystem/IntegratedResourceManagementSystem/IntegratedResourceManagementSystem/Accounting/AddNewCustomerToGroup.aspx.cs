...
{
    public partial class AddNewCustomerToGroup : System.Web.UI.Page
    {
        #region variables
        private InventoryGroup inventoryGroup
        {
            get
            {
                ...
                {
                     GroupName =(string)Request.QueryString["GroupName"],
                      InventoryGroupId = long.Parse(Request.QueryString["GroupNumber"])                    
                };
            }
        }
        ...
        private void SaveInventoryGroup()
        {
            ...
            {
                cust_.InventoryGroupId = inventoryGroup.InventoryGroupId;
        ...
        protected void btnFilterByBrand_Click(object sender, EventArgs e)
        {
            ...
            {
                InvGroupManager.SearchCustomer(SqlDataSourceOutletsByBrand, txtSearch.Text,inventoryGroup.InventoryGroupId,DDLBrands.SelectedValue);
            }
        }
        ...
        protected void btnReloadOutletList_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtSearch.Text))
            {
                InvGroupManager.SearchCustomer(SqlDataSourceOutlets, txtSearch.Text, inventoryGroup.InventoryGroupId);
            }
        }
