...
CodeBehind="SalesInvoiceLiqUpdate.aspx.cs" Inherits="IntegratedResourceManagementSystem.Accounting.SalesInvoiceLiqUpdate" %>
     ...
     <div style="height: 260px; class="modalDrag">
			<table style="">
                    ...
                    <tr>
						...
						<td>
							<asp:TextBox CssClass="modalText" Width="150px" Height="20px" ID="txtSoldTo" runat="server"></asp:TextBox>
						</td>
                        <td>
						</td>
						<td class="modalLabel">
                    ...
                    <tr>
						...
						<td>
							<asp:TextBox CssClass="modalText" Width="200px" Height="20px" ID="txtAmount" runat="server"></asp:TextBox>
						</td>
					...
					<tr>
                        ...
                        <tr>
                            ...
                            Text="FINALIZE TRANSACTION" /></td>
                            <asp:ModalPopupExtender ID="btnFinalizeTransaction_ModalPopupExtender" 
                                    runat="server" BackgroundCssClass="bgModal"
                                CancelControlID="imgBtnCloseConfirmation" DynamicServicePath="" Enabled="True" PopupControlID="pnlConfirmation"
    ...
    <asp:Panel ID="pnlOutlets" runat="server" CssClass="modal">
                ...
                <div style="margin-left: 5px; height:30px;">
                      <div class="SearchTextContainer">
                       SEARCH:  <asp:TextBox ID="txtSearchCustomer" runat="server" CssClass="modalText" Height="16px"></asp:TextBox>
                        <asp:ImageButton ID="imgBtnSearchCustomer" runat="server"  ImageUrl="~/Resources/search.png"
                            ImageAlign="AbsMiddle" ToolTip="SEARCH" 
                              onclick="imgBtnSearchCustomer_Click" />
                    </div>
                </div>
            ...
            <asp:Panel ID="pnlConfirmation" runat="server" CssClass="modal">
				<asp:Panel ID="pnlSelectedDRPreviewDrag" runat="server" CssClass="modalDrag">
					<div class="close_btn">
						<asp:ImageButton ID="imgBtnCloseConfirmation" runat="server" CssClass="btnClose"
							ImageUrl="~/Resources/cancel_gray.png" ToolTip="CLOSE" />
					</div>
					<div id="divFinTrab" class="sizeLogo" runat="server" style="">
